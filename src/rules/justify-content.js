 ...
 * order 210
 */
import { PREFIX, JUSTIFY_CONTENT_ENUM, JUSTIFY_CONTENT_ENUM_STR, toRegexStr, genSnippets } from '../constant';
...
export default {
	...
	snippets(config) {
		return genSnippets(ruleName, config.prefix, className, JUSTIFY_CONTENT_ENUM);
	},
};
